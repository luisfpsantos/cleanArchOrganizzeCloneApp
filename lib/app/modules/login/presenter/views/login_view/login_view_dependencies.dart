...
class LoginViewDependencies {
  static List<SingleChildWidget> providers() {
    return [
      ...
      Provider<GetUserInDatabaseDatasource>(
        create: (_) =>
            GetUserInDatabaseDatasourceImp(FirebaseFirestore.instance),
      ),
      Provider<GetUserInDatabaseRepository>(
        create: (context) => GetUserInDatabaseRepositoryImp(context.read()),
      ),
      Provider<GetUserInDatabaseUsecase>(
        create: (context) => GetUserInDatabaseUsecaseImp(context.read()),
      ),
      Provider(
